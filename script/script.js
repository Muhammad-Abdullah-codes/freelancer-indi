...
const sectionHTML = `
            <section class="bor mx-5 p-6 mb-5 bg-white">
          ...
          <p class="bg-gray-50 mt-2 p-2 rounded-xl">
            ...
            <div class="flex gap-1 sm:gap2 mt-4">
              <button class="flex items-center but3 font-bold gap-2 bg-purple-100 sm:px-3 py-1 text-xs sm:text-sm px-1"><img width="18" src="img/dashboard.png" alt=""> Dashboard</button>
              <button class="flex items-center but4 font-bold gap-2 bg-orange-100 sm:px-3 py-1 text-xs sm:text-sm px-1"><img width="18" src="img/dot.png" alt=""> Medium</button>
            </div>
